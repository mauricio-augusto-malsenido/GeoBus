...
public class PutUbicacionAnteriorUsuarioResponse {
    private String respuesta;
    private UbicacionAnteriorUsuario ubicacionAnteriorUsuario;

    public PutUbicacionAnteriorUsuarioResponse(String respuesta, UbicacionAnteriorUsuario ubicacionAnteriorUsuario) {

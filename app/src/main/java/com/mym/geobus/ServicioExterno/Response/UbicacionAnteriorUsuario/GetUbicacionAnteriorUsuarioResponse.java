...
public class GetUbicacionAnteriorUsuarioResponse {
    private String respuesta;
    private UbicacionAnteriorUsuario ubicacionAnteriorUsuario;

    public GetUbicacionAnteriorUsuarioResponse(String respuesta, UbicacionAnteriorUsuario ubicacionAnteriorUsuario) {

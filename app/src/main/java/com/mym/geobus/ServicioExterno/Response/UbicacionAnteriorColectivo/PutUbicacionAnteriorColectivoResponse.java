...
public class PutUbicacionAnteriorColectivoResponse {
    private String respuesta;
    private UbicacionAnteriorColectivo ubicacionAnteriorColectivo;

    public PutUbicacionAnteriorColectivoResponse(String respuesta, UbicacionAnteriorColectivo ubicacionAnteriorColectivo) {
